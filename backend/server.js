...
// Permissive CORS to satisfy production frontend and traditional hosting
const corsOptions = {
...
// Reuse Prisma client if possible; in traditional server it will be single instance
